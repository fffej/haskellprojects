...
keyboardMouseHandler s (SpecialKey KeyUp) Down _ _ = env s $~ (moveGoal (1,0))
keyboardMouseHandler s (SpecialKey KeyDown) Down _ _ = env s $~ (moveGoal (-1,0))
keyboardMouseHandler s (SpecialKey KeyLeft) Down _ _ = env s $~ (moveGoal (0,1))
keyboardMouseHandler s (SpecialKey KeyRight) Down _ _ = env s $~ (moveGoal (0,-1))
